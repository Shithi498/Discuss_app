                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color:
                            isMe ? const Color(0xff714B67) : Colors.white,
        ...
        return SafeArea(
          child: Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.circular(28), // Equal curves on all corners
              ),
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        onTap: () async {
                          ...
                          if (newText != null &&
                            ...
                            if (success && mounted) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text("Failed to edit: ${chatProvider.error ?? 'Unknown Error'}"),
                                ),
                              );
                            }
                          }
                    ...
                    ListTile(
                      ...
                      title: const Text(
                        "Delete Message",
                        style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.w500, fontSize: 14),
                      ),
                      onTap: () async {
                        Navigator.pop(bottomSheetContext);
                        ...
                        if (confirmDelete == true) {
                          ...
                          if (success && mounted) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text("Delete failed: ${chatProvider.error ?? 'Unknown Error'}"),
                              ),
                            );
                          }
                        }
